...
class CommentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ErazrSiteBundle:Comment')->findAll();
     ...
     * @Method("POST")
     * @Template("ErazrSiteBundle:Comment:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ErazrSiteBundle:Comment')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ErazrSiteBundle:Comment:edit.html.twig")
     */
